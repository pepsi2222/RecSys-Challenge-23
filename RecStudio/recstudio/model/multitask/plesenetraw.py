...
class PLESEnetRaw(BaseRanker):
    ...
    def _init_model(self, train_data, drop_unused_field=True):
        ...
        self.extraction_layers = nn.Sequential(*[
                                    ctr.ExtractionLayer(
                                        2*self.embedding.num_features * self.embed_dim if i == 0 else model_config['expert_mlp_layer'][-1],
    ...
    def score(self, batch):
        ...
        emb = self.senet(emb_)
        emb = torch.cat([emb_, emb], dim=-1).flatten(1)
