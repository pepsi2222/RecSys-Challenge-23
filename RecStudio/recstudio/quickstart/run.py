...
def pred(model: str, dataset: str, model_config: Dict=None, data_config: Dict=None, model_config_path: str=None, data_config_path: str=None, verbose=True, **kwargs):
    model_class, model_conf = get_model(model)
    ...
    model.load_checkpoint("/root/autodl-tmp/yankai/Sharechat-RecSys-Challenge-23/saved/MaskNet/recsys/2023-05-05-10-36-27.ckpt")      
    model.eval()
