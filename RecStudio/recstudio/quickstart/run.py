...
def pred(model: str, dataset: str, ckpt_path: str, model_config: Dict=None, data_config: Dict=None, model_config_path: str=None, data_config_path: str=None, verbose=True, **kwargs):
    model_class, model_conf = get_model(model)
    ...
    save_dir = os.path.join('./predictions', f'{model.__class__.__name__}')
    save_path = os.path.join(save_dir, ckpt_name + f'{str(model.frating)}.csv')
