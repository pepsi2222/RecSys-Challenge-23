...
ops = ['dropout', 'embed_dim', 'num_layers', 'weight_decay']

log_dir = '/data2/home/xingmei/RecSys23/log/DCN/finetune'
...
df.sort_values(by=['dropout', 'embed_dim', 'num_layers', 'weight_decay'])
df = df[['dropout', 'embed_dim', 'num_layers', 'weight_decay',
         'auc', 'logloss', 'epoch' 
         ]]
# print(df)    
